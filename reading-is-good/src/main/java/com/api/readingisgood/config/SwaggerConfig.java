package com.api.readingisgood.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.api.readingisgood"))
    ...
    private ApiInfo info() {
        return new ApiInfoBuilder().title("Quick start project")
                ...
                .contact(new Contact("Haluk Tiras", "https://github.com/haluktiras",
                        "haluktiras@gmail.com"))
                .version("1.0.0")
